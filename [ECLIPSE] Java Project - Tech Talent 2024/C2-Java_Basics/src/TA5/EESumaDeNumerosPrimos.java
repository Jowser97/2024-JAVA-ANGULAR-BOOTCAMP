...
public class EESumaDeNumerosPrimos {
	...
	public static void main(String[] args) {
		...
		/*
		 * Desarrolla un programa que solicite al usuario un número entero y luego
		 * calcule la suma de todos los números primos hasta ese número. Utiliza un
		 * bucle for o un bucle while para iterar sobre los números y verifica si son
		 * primos.
		 */
